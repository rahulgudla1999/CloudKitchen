  ...
  rice: {
    ...
    dishes: [
      ...
      },
      {
        ...
        image: '/assets/chicken_pulav.png',
      },
      {
        name: 'Bagara Rice',
        spice: '●',
...
export const galleryItems = [
  { name: 'Chicken Biryani', price: '₹220', image: '/assets/chicken_biryani.png', alt: 'Sircilla Chicken Biryani — layered dum biryani' },
  { name: 'Kodi Kura', price: '₹210', image: '/assets/chicken_curry.png', alt: 'Kodi Kura — spicy Telangana chicken curry' },
  { name: 'Bagara Rice', price: '₹150', image: '/assets/bagara_rice.png', alt: 'Bagara Rice — ghee-tempered fragrant rice' },
  { name: 'Mamsam Kura', price: '₹260', image: '/assets/mutton_curry.png', alt: 'Mamsam Kura — slow-cooked mutton curry' },
];
